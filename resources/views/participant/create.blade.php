            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">{{ __('Add Participant') }}</h6>
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ __('Add Participant') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('participants.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <input class="form-control form-control" name="password" placeholder="Password"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <input class="form-control form-control" name="agency" placeholder="Agency"
                                        type="text" value="{{ old('agency') }}" required>
                                </div>
                                @error('agency')
                                    <small class="text-danger" role="alert">
                                        {{ $message }}
